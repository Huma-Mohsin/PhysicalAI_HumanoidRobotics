...
1. ✅ Master NVIDIA Isaac Sim for photorealistic simulation
2. ✅ Generate synthetic training data for AI models
3. ✅ Implement Isaac ROS for hardware-accelerated VSLAM
4. ✅ Use Nav2 for path planning and navigation
5. ✅ Deploy perception pipelines on NVIDIA Jetson
6. ✅ Execute sim-to-real transfer workflows
...
1. ✅ Create a humanoid robot in Isaac Sim
2. ✅ Implement VSLAM using Isaac ROS
3. ✅ Generate a 3D map with nvblox
4. ✅ Set up Nav2 for autonomous navigation
5. ✅ Deploy to NVIDIA Jetson (Sim-to-Real)
...
👉 **Next**: [Module 4: Vision-Language-Action (VLA)](./module-4-vla)
